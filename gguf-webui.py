...
# プロンプトタイプ("rinna","vicuna","alpaca","llama2","openbuddy","airoboros","beluga","ja-stablelm","qa","none")
PROMPT_TYPE = "rinna"
...
parser.add_argument("--prompt-type", type=str, choices=["rinna", "vicuna", "alpaca", "llama2", "openbuddy", "airoboros", "codellama", "elyzallama2", "beluga", "ja-stablelm", "qa", "none"], default=PROMPT_TYPE, help="プロンプトタイプ名")
